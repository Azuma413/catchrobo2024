...
const std::vector<FingerConfig> finger_config = {
    {1, 0.0, 2*M_PI, 0.0, false}, // 親指0
    {2, 0.0, 2*M_PI, 0.0, false}, // 親指1
    {3, 0.0, 2*M_PI, 0.0, false}, // 人差し指0
    {4, 0.0, 2*M_PI, 0.0, false}, // 人差し指1
    {5, 0.0, 2*M_PI, 0.0, false}, // 中指0
    {6, 0.0, 2*M_PI, 0.0, false}, // 中指1
    {7, 0.0, 2*M_PI, 0.0, false}, // 薬指0
    {8, 0.0, 2*M_PI, 0.0, false}, // 薬指1
    {9, 0.0, 2*M_PI, 0.0, false}, // 小指0
    {16, 0.0, 2*M_PI, 0.0, false} // 小指1
};
